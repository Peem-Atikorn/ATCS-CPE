# -*- coding: utf-8 -*-
# Load and parse solar_cell_q_a.txt into records shared by problem01-10.
#
...
DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "solar_cell_q_a.txt")
