# -*- coding: utf-8 -*-
# Problem 09: CHUNK_SIZE / OVERLAP / EVAL_K_VALUES on real data from solar_cell_q_a.txt
import sys
...
def run():
    ...
    print(f"Real document from solar_cell_q_a.txt is {total_chars} characters long ({len(data)} Q&A)")
    ...
    print("Golden Set =", len(data), "(uses every question in solar_cell_q_a.txt as the test set)")
