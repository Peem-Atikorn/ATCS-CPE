...
# Simulates the kind of noise commonly seen during scraping/OCR on real questions from solar_cell_q_a.txt
...
def run():
    ...
    print(f"\nChecked the full solar_cell_q_a.txt file ({len(data)} entries): found {dup_count} duplicate question(s) after normalization")
