...
# Domain: solar cell / photovoltaic system knowledge base (data/solar_cell_q_a.txt).
...
SYSTEM_PROMPT = """คุณคือผู้ช่วยให้ข้อมูลด้านโซลาร์เซลล์และระบบผลิตไฟฟ้าพลังงานแสงอาทิตย์ ตอบโดยอ้างอิงจาก "ข้อมูลอ้างอิง" ที่ให้มาเท่านั้น
...
4. ใช้ภาษาสุภาพ ตรงไปตรงมา อธิบายศัพท์เทคนิคสั้น ๆ เมื่อจำเป็น
5. ถ้าเป็นงานที่เสี่ยงอันตราย เช่น ต่อสายไฟแรงดันสูง งานบนหลังคา หรือเชื่อมต่อระบบ on-grid ให้เตือนว่าควรให้ช่างผู้มีใบอนุญาตดำเนินการ
...
# --------------------------------------------------- query transform
REWRITE_PROMPT = """แปลงคำถามให้ชัดเจนและเหมาะกับการค้นหาในฐานข้อมูลโซลาร์เซลล์
- แก้คำสะกดผิด แทนคำพูดทั่วไปด้วยศัพท์ทางเทคนิค เช่น แผงโซลาร์เซลล์ อินเวอร์เตอร์ MPPT ระบบออนกริด
...
- ใช้คำต่างกัน ทั้งภาษาพูดและศัพท์ทางเทคนิคด้านโซลาร์เซลล์
...
HYDE_PROMPT = """เขียน "คำตอบสมมติ" สำหรับคำถามนี้ ในสำนวนเดียวกับบทความให้ความรู้ด้านพลังงานแสงอาทิตย์
