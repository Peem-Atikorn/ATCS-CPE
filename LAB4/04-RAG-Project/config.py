...
SOURCE_FILE = os.path.join(DATA_DIR, "solar_cell_q_a.txt")
...
# คำถามที่ไม่เกี่ยวกับโซล่าเซลล์เลย (เช่น "เบอร์เกอร์กี่แคล") ก็ยังมี chunk ที่ "ใกล้สุดในบรรดาที่มี"
# เสมอ ทั้ง dense และ BM25 ไม่มีขั้นไหนเช็คว่าใกล้ "พอ" ไหม เลยต้องกรองด้วย cosine similarity ขั้นต่ำ
# เทียบจากการทดสอบจริง: คำถามที่เกี่ยวข้องได้คะแนน 0.54-0.85 ส่วนคำถามที่ไม่เกี่ยวข้องได้แค่ 0.27-0.41
MIN_RELEVANCE_SCORE = 0.45   # ถ้าไม่มี chunk ไหนถึงคะแนนนี้ ถือว่าไม่พบข้อมูลที่เกี่ยวข้องเลย
