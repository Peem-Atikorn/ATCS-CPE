...
SAMPLE_QUERIES = [
    "แผงโมโนคริสตัลไลน์กับโพลีต่างกันอย่างไร",
    "ระบบ On-Grid เหมาะกับใคร",
    "อัตรารับซื้อไฟฟ้าโซลาร์ภาคประชาชน 2569 คือเท่าไร",
    "เกิดจุดร้อน Hot Spot บนแผงแก้ยังไง",
    "การติดตั้งโซล่าเซลล์ต้องขออนุญาตหน่วยงานใดบ้าง",
]
